        ...
        <div className="flex gap-3">
          ...
          {search && (
            <button
              ...
              className="bg-[#334155] hover:bg-[#475569] text-slate-300 px-4 py-2.5 rounded-lg text-sm transition-colors"
            >
              Clear
            </button>
          )}
            ...
            <tbody>
              {contacts.map((contact) => (
                <tr key={contact.id} className="border-b border-[#334155]/50 hover:bg-[#334155]/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-slate-300">{contact.deals.length}</td>
