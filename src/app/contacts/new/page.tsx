      ...
      <form onSubmit={handleSubmit} className="bg-[#1e293b] rounded-xl border border-[#334155] p-6 space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full bg-[#0f172a] border border-[#334155] rounded-lg px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <Link href="/contacts" className="text-slate-400 hover:text-slate-300 px-4 py-2.5 text-sm transition-colors">
            Cancel
          </Link>
        </div>
      </form>
