...
const dbPath = path.resolve(seedDir, "../dev.db");
...
async function main() {
  ...
  const contacts = await Promise.all([
    prisma.contact.create({ data: { name: "Sarah Chen", email: "sarah.chen@techcorp.com", phone: "+1 (415) 555-0101", company: "TechCorp", notes: "VP of Engineering. Key decision maker for enterprise deals.", tags: JSON.stringify(["enterprise", "vip"]) } }),
    prisma.contact.create({ data: { name: "Marcus Johnson", email: "marcus.j@innovate.io", phone: "+1 (212) 555-0202", company: "Innovate.io", notes: "CTO. Interested in AI-powered automation tools.", tags: JSON.stringify(["startup", "ai-interest"]) } }),
    prisma.contact.create({ data: { name: "Emily Rodriguez", email: "emily.r@globalfin.com", phone: "+1 (312) 555-0303", company: "GlobalFin", notes: "Director of Operations. Budget approved for Q1.", tags: JSON.stringify(["enterprise", "finance"]) } }),
    prisma.contact.create({ data: { name: "David Park", email: "david.park@nexusai.com", phone: "+1 (650) 555-0404", company: "NexusAI", notes: "Founder. Looking for partnership opportunities.", tags: JSON.stringify(["partner", "ai-interest"]) } }),
    prisma.contact.create({ data: { name: "Lisa Thompson", email: "lisa.t@retailplus.com", phone: "+1 (305) 555-0505", company: "RetailPlus", notes: "Head of Digital Transformation.", tags: JSON.stringify(["retail", "enterprise"]) } }),
    prisma.contact.create({ data: { name: "James Wilson", email: "james.w@cloudserv.net", phone: "+1 (503) 555-0606", company: "CloudServ", notes: "Senior architect. Evaluating cloud migration.", tags: JSON.stringify(["cloud", "technical"]) } }),
    prisma.contact.create({ data: { name: "Ana Martinez", email: "ana.m@healthtech.org", phone: "+1 (617) 555-0707", company: "HealthTech", notes: "Product Manager. Healthcare compliance required.", tags: JSON.stringify(["healthcare", "compliance"]) } }),
    prisma.contact.create({ data: { name: "Robert Kim", email: "robert.kim@datavault.com", phone: "+1 (206) 555-0808", company: "DataVault", notes: "CEO. Fast-growing data analytics company.", tags: JSON.stringify(["analytics", "vip"]) } }),
    prisma.contact.create({ data: { name: "Priya Sharma", email: "priya.s@edulearn.com", phone: "+1 (408) 555-0909", company: "EduLearn", notes: "VP Product. EdTech sector, large user base.", tags: JSON.stringify(["edtech", "growth"]) } }),
    prisma.contact.create({ data: { name: "Michael Brown", email: "michael.b@mfgcorp.com", phone: "+1 (713) 555-1010", company: "MfgCorp", notes: "Operations Director. Manufacturing automation.", tags: JSON.stringify(["manufacturing", "enterprise"]) } }),
  ]);
