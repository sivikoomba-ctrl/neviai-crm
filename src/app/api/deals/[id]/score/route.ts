...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      else if (deal.value > 20000) score += 10;
      else if (deal.value > 5000) score += 5;

      const stageScores: Record<string, number> = {
        Lead: 0, Qualified: 10, Proposal: 20, Negotiation: 25, Won: 30, Lost: -20,
      };
      ...
      if (score >= 75) advice = "Strong deal - prioritize closing. Schedule a follow-up meeting this week.";
      else if (score >= 50) advice = "Promising deal. Increase engagement frequency and address any remaining objections.";
      else if (score >= 25) advice = "Needs nurturing. Focus on building relationship and demonstrating value.";
      else advice = "At risk. Re-evaluate qualification and consider pivoting approach.";
    }
